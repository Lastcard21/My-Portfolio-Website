  ...
  return (
    <div className="w-full md:h-12 sm:h-14 h-18 flex flex-col md:flex-row justify-center md:justify-between items-center xl:px-36 lg:px-24 md:px-12 sm:px-6 px-4 fixed top-0 z-50 bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <div>
        <a
          href="#home"
          className={`group lg:text-lg md:text-base text-sm font-light lg:mr-12 mr-8 tracking-wide relative ${activeSection === 'home' ? 'text-red-500 dark:text-yellow-500' : 'text-gray-600 dark:text-white'}`}
        ...
        <a
          href="#services"
          className={`group lg:text-lg md:text-base text-sm font-light text-gray-600 dark:text-white lg:mr-12 mr-8 tracking-wide relative ${activeSection === 'services' ? 'text-red-500 dark:text-yellow-500' : 'text-gray-600 dark:text-white'}`}
        ...
        <a
          href="#contact"
          className={`group lg:text-lg md:text-base text-sm font-light text-gray-600 dark:text-white lg:mr-12 mr-8 tracking-wide relative ${activeSection === 'contact' ? 'text-red-500 dark:text-yellow-500' : 'text-gray-600 dark:text-white'}`}
