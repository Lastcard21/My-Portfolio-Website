...
const Services = () => {
  ...
  return (
    <div id="services" className='min-height-screen flex flex-col justify-center items-center px-4 xl:py-0 py-10'>
      ...
      <div className='w-full xl:w-[900px] lg:w-[850px] md:w-[600px] grid lg:grid-cols-3 grid-cols-1 lg:gap-12 gap-32 xl:mb-0 mb-16'>
        {skillCards.map((card,index) => (
            <div key={index} className='relative lg:max-w-[280px] md:max-w-[400px] max-w-320px mx-auto rounded-sm ring-2 ring-gray-400/20 shadow-md shadow-gray-700/20 isolate' onMouseEnter={() => setHoveredCardIndex(index)} onMouseLeave={() => setHoveredCardIndex(null)}>
                <div className='p-3 bg-gray-200 dark:bg-gray-800 transition-colors duration-500'>
                  ...
                  <div className={`w-full absolute left-0 ${getPositionClass(card)} flex flex-col gap-y-5 py-4 transition-all duration-500 -z-10 ${hoveredCardIndex === index && `${getHoverPositionClass(card)}`}`}>
                    ...
                    <h2 className='text-2xl text-center text-gray-900 dark:text-white font-light tracking-wide'>Projects</h2>
